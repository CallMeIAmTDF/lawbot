...
import com.example.template.advice.exception.IdInvalidException;
import com.example.template.dto.ApiResponse;
import com.example.template.dto.request.AuthenticationRequest;
...
import com.example.template.service.AuthenticationService;
...
//    }
    ...
    ResponseEntity<ApiResponse<AuthenticationResponse>> refreshToken(@CookieValue(name = "refresh_token", defaultValue = "defaultToken") String refresh_token) throws IdInvalidException, ParseException, JOSEException, ParseException, JOSEException {
